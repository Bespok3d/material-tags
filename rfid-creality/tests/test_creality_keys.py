...
def test_parse_key_accepts_clean_hex():
    parsed = parse_key("713362755e74316e71665a2870662431")
    assert parsed is not None
    assert len(parsed) == 16


def test_parse_key_strips_separators_and_case():
    spaced = parse_key(" 71:33:62:75:5E:74:31:6E:71:66:5A:28:70:66:24:31 ")
    assert spaced == bytes.fromhex("713362755e74316e71665a2870662431")
